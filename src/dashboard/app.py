...
# Agent Interactions page
    ...
    # Create a Gantt chart for agent activity
    df = pd.DataFrame([
        dict(Task="Issue Analyzer", Start='2023-06-01', Finish='2023-06-01 00:05', Resource="Analysis"),
        dict(Task="Memory Lookup", Start='2023-06-01 00:05', Finish='2023-06-01 00:06', Resource="Memory"),
        dict(Task="Code Fixer", Start='2023-06-01 00:06', Finish='2023-06-01 00:10', Resource="Fixing"),
        dict(Task="Feedback", Start='2023-06-01 00:10', Finish='2023-06-01 00:11', Resource="Feedback"),
        dict(Task="Git Operations", Start='2023-06-01 00:11', Finish='2023-06-01 00:12', Resource="Git"),
        dict(Task="PR Creator", Start='2023-06-01 00:12', Finish='2023-06-01 00:14', Resource="PR")
    ])
